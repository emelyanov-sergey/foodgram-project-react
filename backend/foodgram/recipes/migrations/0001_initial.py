# Generated by Django 3.2 on 2023-08-03 22:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('measure', models.CharField(help_text='Обязательное поле', max_length=15, verbose_name='Единицы измерения')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, help_text='Обязательное поле', null=True, upload_to='', verbose_name='Картинка')),
                ('cooking_time', models.PositiveIntegerField(default=0, help_text='Обязательное поле', validators=[django.core.validators.MinValueValidator(1, 'Время приготовления должно быть больше 1 минуты')], verbose_name='Время приготовления в минутах')),
                ...
                ('ingredients', models.ManyToManyField(help_text='Обязательное поле', related_name='RecipeIngredient', to='recipes.Inredient', verbose_name='Список ингредиентов')),
            ],
            options={
                'verbose_name': 'Рецепт',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recipeingredients', to='recipes.inredient', verbose_name='Ингредиент')),
